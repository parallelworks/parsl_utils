...
"""
Modified version of https://github.com/Parsl/parsl/blob/master/parsl/data_provider/files.py
to explicitly accept the local_path (worker_path)
...
class File(object):
    ...
    def __init__(self, url: str, local_path: str):
        ...
        self.local_path = local_path  # type: Optional[str]
